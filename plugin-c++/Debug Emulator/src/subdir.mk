...
src/%.o: ../src/%.cpp
	...
	i686-pc-linux-gnu-g++ -D_DEBUG -I"C:\Archivos de programa\HP webOS\PDK\include" -I"C:\Archivos de programa\HP webOS\PDK\include\SDL" -I"C:\Archivos de programa\HP webOS\PDK\include\openssl" -O0 -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
