...
src/%.o: ../src/%.cpp
	...
	i686-pc-linux-gnu-g++ -D_DEBUG -D_PIXI_ -I"C:\Archivos de programa\Palm\PDK\include" -I"C:\Archivos de programa\Palm\PDK\include\SDL" -I"C:\Archivos de programa\Palm\PDK\include\openssl" -O0 -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
